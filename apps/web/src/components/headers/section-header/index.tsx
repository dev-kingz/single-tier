...
const SectionHeader = ({title, className, icon, children}: SectionHeaderProps) => {
  return (
    <section
      className={cn("SectionHeader flexib sm:px-42 w-full flex-col gap-2 pb-4 sm:gap-4", className)}
    >
