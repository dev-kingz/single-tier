...
const Introduction = () => {
  return (
    <section className="Introduction flexit-it px-8 py-4 sm:px-48">
      <p className="Text">
        Welcome to DevKingz!
        <br />
        <br />
        These terms and conditions outline the rules and regulations for the use of DevKingz&apos;s
        Website, located at devkingz.com
        <br />
        <br />
        By accessing this website we assume you accept these terms and conditions. Do not continue
        to use DevKingz if you do not agree to take all of the terms and conditions stated on this
        page.
        <br />
        <br />
        ...
        respect of provision of the Company&apos;s stated services, in accordance with and subject
