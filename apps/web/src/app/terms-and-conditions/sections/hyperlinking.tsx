...
const Hyperlinking = () => {
    return (
        <section className="HyperlinkingSection flexit-it flex-col px-8 sm:px-48">
            <SectionHeader title="Hyperlinking to our Content" />
            <p className="Text" >
            ...
            >
                ...
                visibility of the hyperlink compensates the absence of DigiLearn; and (d) the link is in
                ...
                linking to our website, you must inform us by sending an e-mail to DigiLearn. Please
            ...
            <p>
                <br />
                No use of DigiLearn&apos;s logo or other artwork will be allowed for linking absent a
